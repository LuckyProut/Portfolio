...
function Header() {
    return(
        <header id="header" className="header__container">
            <NavLink to="/Portfolio"><img src={logoHeader} alt="Logo site Luc Garrouste"/></NavLink>
            <nav>
                <NavLink to="/Portfolio" className="header__container__site lien-menu">Projets</NavLink>
